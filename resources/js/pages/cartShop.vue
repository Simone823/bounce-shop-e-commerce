        ...
        <section id="cart_shop">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Product wrapper -->
                    <div
                        v-if="cart_shop != null && cart_shop.length"
                        class="col-12 col-sm-6 product_wrapper mb-5 mb-sm-0"
                    >
                        <!-- product list -->
                        <ul class="product_list">
                            <li
                                class="mb-5"
                                v-for="(product, index) in cart_shop"
                                :key="index"
                            >
                                <!-- product image -->
                                ...
                                <div class="total_cart">
                                    ...
                                    <button
                                        @click="
                                            removeItemFromCartShop(product.id)
                                        "
                    ...
                    <div
                        v-if="cart_shop != null && cart_shop.length"
                        class="col-12 col-sm-6 total_cart_shop"
                    >
                        <div class="card py-3">
                            ...
                            <div class="card-body pb-0">
                                <ul class="detail_total mb-4">
                                    <li
                                        class="d-flex justify-content-between mb-2 flex-wrap"
                                    >
                                ...
                                <!-- user detail -->
                                <div
                                    class="user_detail mb-4"
                                    v-if="auth_user_id != 'null'"
                                >
                                    ...
                                    <ValidationObserver ref="form">
                                        ...
                                        >
                                            ...
                                            <validationProvider
                                                tag="div"
                                                class="col-12 validation_provider mb-4"
                                                name="user_name"
                                            ...
                                            >
                                                <div class="form-floating">
                                                    <input
                                                        ...
                                                        type="text"
                                                        name="user_name"
                                                        class="form-control text-black bg-dark text-white border-0"
                                                        id="user_name"
                                                        placeholder="Nome"
                                                    />
                                                    <label for="user_name">
                                ...
                                <div v-else class="register_btn">
                                    <a
                                        href="/login"
                                        class="btn btn-primary text-white w-100"
                                        >Accedi o Registrati per effettuare
                                        un'ordine</a
                                    >
                                </div>
                            </div>
                    ...
                    <div v-else class="col-12 text-center">
                        ...
                        <a class="btn btn-primary text-white" href="/products"
                            >Vai alla pagina prodotti per acquistare</a
                        >
                    </div>
                </div>
            </div>
